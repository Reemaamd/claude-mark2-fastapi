...
# Pour voir le début du prompt
    ...
    try:
        ...
        raise TimeoutError("Le LLM local a mis trop de temps à répondre (timeout dépassé).")
    except httpx.ConnectError:
        raise ConnectionError("Impossible de contacter Ollama. Vérifie qu'il est bien lancé (ollama serve).")